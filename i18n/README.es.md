...
> 🎬 **¿Has hecho un video sobre 9Router?** Envía una [Pull Request](https://github.com/jarjut/9router/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!
...
docker pull jarjut/9router:latest   # actualiza a la última versión
```
...
- **Problemas**: [github.com/jarjut/9router/issues](https://github.com/jarjut/9router/issues)
