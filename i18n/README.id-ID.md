...
MIT License — lihat [LICENSE](https://github.com/jarjut/9router/blob/main/LICENSE) untuk detailnya.

---

<div align="center">

**Kalau 9Router membantumu, kasih ⭐ di [GitHub](https://github.com/jarjut/9router)!**

[🌐 Website](https://9router.com) • [📦 npm](https://www.npmjs.com/package/@jarjut/9router) • [🐛 Laporkan Bug](https://github.com/jarjut/9router/issues)
