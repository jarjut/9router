...
const COLORS = {
  ...
  bgBlue: "\x1b[44m",
  black: "\x1b[30m",
  primary: "\x1b[38;2;37;99;235m",     // Electric blue (#2563EB)
  bgPrimary: "\x1b[48;2;37;99;235m",   // Electric blue bg (#2563EB)
  terracotta: "\x1b[38;2;37;99;235m",  // Backward-compat alias to primary
  bgTerracotta: "\x1b[48;2;37;99;235m"
};
...
async function selectMenu(title, items, defaultIndex = 0, subtitle = "", headerContent = "", breadcrumb = []) {
  return new Promise((resolve) => {
    ...
    const renderMenu = () => {
      ...
      console.log(`\n${COLORS.primary}${"=".repeat(width)}${COLORS.reset}`);
      console.log(`  ${COLORS.bright}${COLORS.primary}${title}${COLORS.reset}`);
      if (subtitle) console.log(`  ${COLORS.dim}${subtitle}${COLORS.reset}`);
      console.log(`${COLORS.primary}${"=".repeat(width)}${COLORS.reset}`);
