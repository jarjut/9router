...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/jarjut/9router/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://9router.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "@jarjut/9router",
  installCmd: "npm i -g @jarjut/9router",
  installCmdLatest: "npm i -g @jarjut/9router@latest --prefer-online",
